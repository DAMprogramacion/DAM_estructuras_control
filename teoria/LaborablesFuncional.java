...
public class LaborablesFuncional {
	...
	public static void main (String[] args) {
		...
		switch (iDia) {
			case 1, 2, 3, 4, 5 -> System.out.println(iDia + " es lectivo");
			case 0, 6          -> System.out.println(iDia + " NO es lectivo");
			default            -> System.out.println(iDia + " no válido");
		}
